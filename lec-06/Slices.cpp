...
public:
    ...
    int maxSizeSlices(vector<int>& slices) {
        ...
        int k = slices.size();
        int case1 = solve(0 , k-2 ,slices ,k/3);// when 1st slices eaten by the me;
        int case2 = solve(1 ,k -1, slices ,k/3);// when last slice eaten by me firstly;
...
public:
    ...
    int maxSizeSlices(vector<int>& slices) {
        ...
        int case1 = solve(0 , k-2 ,slices ,k/3 ,dp1);// when 1st slices eaten by the me;

        vector<vector<int>> dp2(k, vector<int>(k ,-1));
        int case2 = solve(1 ,k -1, slices ,k/3,dp2);// when last slice eaten by me firstly;
...
public:
    ...
    int maxSizeSlices(vector<int>& slices) {
        ...
        // when 1st slices eaten by the me;
        // when last slice eaten by me firstly;
